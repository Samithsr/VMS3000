...
=======
        ...
        # Show context menu for 3000/6M with Options, Setpoints, Point Names
            ...
            def on_setpoints(slot):
                # TODO: Implement 3000/6M Setpoints dialog
                print(f"Setpoints for 3000/6M slot {slot}")
...
>>>>>>> 1917283 (add 3000/6m options setpoints and pointnames)
    ...
    # Previously this only allowed even raw slots (2, 4, 6, 8, 10), which
    # forced DIS into fixed pairs like (1,2)/(3,4)/(5,6)/... — so e.g.
    # displayed slot 4 (raw 5) or displayed slot 6 (raw 7) could never
    # start a DIS module even though their neighbor was free.
