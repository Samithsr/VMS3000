"""
newfile.py — VMS 3000  •  New File Confirmation Dialog
Theme-matched to the industrial SCADA palette (navy/steel/amber/teal).
Shows confirmation when creating a new configuration file.
"""
...
class NewFileDialog:
    """
    New File confirmation dialog — VMS 3000 SCADA theme.
    
    Shows confirmation before creating a new configuration file.
    """
    ...
    def _create_message(self, parent):
        ...
        message = (
            ...
            "Any unsaved changes to the current configuration\n"
            "will be lost."
        )
    ...
    def _create_buttons(self):
        ...
        _btn("Yes", self._on_confirm, style="primary")
...
if __name__ == "__main__":
    root = tk.Tk()
    root.title("VMS 3000 - New File Test")
    ...
    def on_new_file():
        dialog = NewFileDialog(root, fonts)
        if dialog.show():
            print("New file confirmed")
            messagebox.showinfo("New File", "Creating new configuration file...", parent=root)
        else:
