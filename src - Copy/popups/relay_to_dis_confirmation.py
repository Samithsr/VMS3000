...
class RelayToDISConfirmationPopup:
    """
    Confirmation popup when switching from Relay module to 3000/12M/DIS.
    
    Shows a message asking if the user wants to switch the relay to 3000/12M/DIS,
    with the rest remaining the same.
    """
    ...
    def __init__(self, parent, fonts, current_module, target_module, on_confirm):
        ...
        Args:
            ...
            current_module: Current module name (e.g., "3000/RLY")
            target_module: Target module name (e.g., "3000/12M/DIS")
    ...
    def _create_dialog(self):
        ...
        tk.Label(
            body,
            text="As it's the same relay, the rest will remain the same.",
...
if __name__ == "__main__":
    ...
    popup = RelayToDISConfirmationPopup(
        root, fonts, "3000/RLY", "3000/12M/DIS", on_confirm
    )
    result = popup.show()
